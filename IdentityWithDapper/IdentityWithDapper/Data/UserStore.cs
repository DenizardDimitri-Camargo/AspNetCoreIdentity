...
{
    public class UserStore : // chama a camada de repositórios de dados ou implementar aqui como será feito com dapper
        IUserStore<ApplicationUser>,
        IUserEmailStore<ApplicationUser>,
        IUserPhoneNumberStore<ApplicationUser>,
        IUserTwoFactorStore<ApplicationUser>,
        IUserPasswordStore<ApplicationUser>,
        IUserRoleStore<ApplicationUser> //representa a tabela intermediário do BD
    {
        ...
        public void Dispose() //não vai fazer dispose de nada
        {
            // Nothing to dispose.
        }
    }
